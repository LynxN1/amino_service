...
class UserProfileList:
    ...
    def UserProfileList(self):
        for x in self.json:
            ...
            try:
                self.backgroundColor.append(x["extensions"]["style"]["coverAnimation"])
            except (KeyError, TypeError):
                self.backgroundColor.append(None)
            try:
...
class RecentBlogs:
    def __init__(self, data):
        ...
        try:
            self.blog: BlogList = BlogList(data["blogList"]).BlogList
        except (KeyError, TypeError):
            self.blog: BlogList = BlogList([])
...
class Community:
    def __init__(self, data):
        ...
        try:
            self.rankingTable: RankingTableList = RankingTableList(
                data["advancedSettings"]["rankingTable"]).RankingTableList
        except (KeyError, TypeError):
            self.rankingTable: RankingTableList = RankingTableList([])
    ...
    def Community(self):
        ...
        try:
            ...
            pass
        try:
            self.themeLeftSidePanelTop = self.json["configuration"]["appearance"]["leftSidePanel"]["navigation"][
                "level1"]
        except (KeyError, TypeError):
            pass
        try:
            self.themeLeftSidePanelBottom = self.json["configuration"]["appearance"]["leftSidePanel"]["navigation"][
                "level2"]
        except (KeyError, TypeError):
            pass
        try:
            self.themeLeftSidePanelColor = self.json["configuration"]["appearance"]["leftSidePanel"]["style"][
                "iconColor"]
        except (KeyError, TypeError):
            pass
        try:
        ...
        for x in self.json:
            ...
            try:
                self.themeLeftSidePanelTop.append(
                    x["configuration"]["appearance"]["leftSidePanel"]["navigation"]["level1"])
            except (KeyError, TypeError):
                self.themeLeftSidePanelTop.append(None)
            try:
                self.themeLeftSidePanelBottom.append(
                    x["configuration"]["appearance"]["leftSidePanel"]["navigation"]["level2"])
            except (KeyError, TypeError):
                self.themeLeftSidePanelBottom.append(None)
            try:
                self.themeLeftSidePanelColor.append(
                    x["configuration"]["appearance"]["leftSidePanel"]["style"]["iconColor"])
            except (KeyError, TypeError):
...
class Message:
    ...
    def Message(self):
        ...
        try:
            ...
            pass
        try:
            self.mentionUserIds = self.json["extensions"]["mentionUserIds"]
        except (KeyError, TypeError):
            pass
    ...
    def __init__(self, data):
        ...
        try:
            self.sticker: StickerCollectionList = StickerCollectionList(
                data["stickerCollectionList"]).StickerCollectionList
        except (KeyError, TypeError):
            self.sticker: StickerCollectionList = StickerCollectionList([])
